  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#05060a] text-white">
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-6 py-32">
        ...
        >
          Para usar la <span className="font-semibold text-white">Ruleta Profesional TSPC</span>,
          necesitas una suscripción activa.
          Desbloquea todas las herramientas avanzadas y domina tus torneos.
        </motion.p>
        ...
        >
          ...
          <h3 className="mb-3 text-xl font-semibold">
            ¿Por qué TSPC Esports?
          </h3>

          <p className="text-white/60">
            Creamos herramientas profesionales para comunidades competitivas.
            Más control, más calidad, más nivel.
          </p>
